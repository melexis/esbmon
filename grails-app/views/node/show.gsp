...
<div class="body">
  ...
  <div class="dialog">
    <table>
      ...
      <tr class="prop">
        <td valign="top" class="name"><g:message code="node.id.label"
                                                 default="Id"/></td>

        <td valign="top"
            class="value">${fieldValue(bean: nodeInstance, field: "id")}</td>
      ...
      <tr class="prop">
        ...
        <td valign="top"
            class="value">${fieldValue(bean: nodeInstance, field: "name")}</td>
