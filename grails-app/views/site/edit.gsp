                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="domainName"><g:message code="site.domainName.label" default="Domain Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: siteInstance, field: 'domainName', 'errors')}">
                                    <g:textField name="domainName" value="${siteInstance?.domainName}" />
                                </td>
                            </tr>
